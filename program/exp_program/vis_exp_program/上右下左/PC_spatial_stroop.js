...
function jitter_practiceRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of jitter_practiceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function judgeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of judgeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function wait_fmriRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of wait_fmriComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function jitterRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of jitterComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function short_restRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of short_restComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function rest_endRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of rest_endComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function long_restRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of long_restComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function long_rest_endRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of long_rest_endComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
